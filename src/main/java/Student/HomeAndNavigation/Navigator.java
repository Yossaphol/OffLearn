...
public class Navigator {
    ...
    public void homeRoute(MouseEvent event){
        navigateTo("/fxml/Student/HomePage/home.fxml", event);

    }

    public void dashboardRoute(MouseEvent event){
        navigateTo("/fxml/Student/statistics/dashboard.fxml", event);
    }

    public void courseRoute(MouseEvent event){
        navigateTo("/fxml/Student/courseManage/course.fxml", event);
    }
    ...
    public void taskRoute(MouseEvent event){
        navigateTo("/fxml/Student/courseManage/task.fxml", event);
    }

    public void roadmapRoute(MouseEvent event){
        navigateTo("/fxml/Student/courseManage/roadmap.fxml", event);
    }

    public void myCourseRoute(MouseEvent event){
        navigateTo("/fxml/Student/courseManage/myCourse.fxml", event);
    }

    public void cartRoute(MouseEvent event){
        navigateTo("/fxml/Student/courseManage/cart.fxml", event);
    }

    public void leaderboardRoute(MouseEvent event){
        navigateTo("/fxml/Student/statistics/leaderboard.fxml", event);
    }

    public void settingRoute(MouseEvent event){
        navigateTo("/fxml/Student/setting/setting.fxml", event);
    }

    public void logoutRoute(MouseEvent event){
        navigateTo("/fxml/Student/LoginSingup/logout.fxml", event);
    }
