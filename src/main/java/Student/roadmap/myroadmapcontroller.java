...
public class myroadmapcontroller implements Initializable {
    ...
    public VBox roadmap_node_column1;
    public VBox roadmap_node_1;
    public HBox roadmap_node_node_box_1;
    public Label roadmap_node_header_1;
    public Label roadmap_node_description;
    public HBox roadmap_node_button_box_1;
    public Button roadmap_node_button_1;
    public VBox roadmap_node_column_2;
    public VBox roadmap_node_2;
    public HBox roadmap_node_header_container_2;
    public Label roadmap_node_header_2;
    public Label roadmap_node_description_2;
    public HBox roadmap_node_button_box_2;
    public Button roadmap_node_button_2;
    public HBox optional_course_container;
    public Pane optional_course_box;
    public VBox optional_course_content_container;
    public Label optional_course_header;
    public Label optional_course_name_1;
    public ImageView optional_course_button;
    public Label optional_course_description_1;
