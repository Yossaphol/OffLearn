...
public class custombigCalendarController {
    ...
    public void initialize() {
        ...
        for (int day = 1; day <= daysInMonth; day++) {
            ...
            dayLabel.setStyle("-fx-font?-family: 'Kodchasan'; -fx-font-weight: bold; -fx-fill: #000000; -fx-font-size: 20px;");
    ...
    private void addEventBlock(int startDay, int startCol, int duration) {
        ...
        eventBlock.setStyle(eventBlock.getStyle() + "-fx-font-size: 20px; -fx-font-weight: bold; -fx-background-radius: 5px; -fx-text-fill: #FFFFFF;");
