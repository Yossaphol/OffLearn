...
public class loginController implements Initializable {
    ...
    private void switchtoSignUp(ActionEvent event) throws IOException {
        ...
        fadeOut.setOnFinished(e -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/client/LoginSingup/signup.fxml"));
                root = loader.load();
    ...
    private void forgotPassword(ActionEvent event) throws IOException {
        ...
        fadeOut.setOnFinished(e -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/client/LoginSingup/forgotPassword.fxml"));
                root = loader.load();
    ...
    public void toLogin(ActionEvent event) throws IOException {
        ...
        fadeOut.setOnFinished(e -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/client/LoginSingup/login.fxml"));
                root = loader.load();
